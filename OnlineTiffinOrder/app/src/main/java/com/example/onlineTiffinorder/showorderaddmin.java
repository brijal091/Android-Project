...
public class showorderaddmin extends AppCompatActivity {
    Button login;
    Button order_lunch;
    RadioButton rdlunch;
    RadioButton rdbfast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showorderaddmin);
        recyclerView=(RecyclerView) findViewById(R.id.order_recycle_admin);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        if(sareprefrencelogin.getInstance(this).islogin())
        {
            User user= sareprefrencelogin.getInstance(showorderaddmin.this).getuser();
            userid=user.getId()+"";

        }

        rdlunch = findViewById(R.id.rdbtnlunchshowadmin);
        rdbfast = findViewById(R.id.rdbtnbreakfastshowadmin);
        rddinner = findViewById(R.id.rdbtndinershowadmin);
        imageButton = findViewById(R.id.imageButtonshowadmin);
    ...
    public void breakfastload(){
        ...
        Call<breakresponce> call= api.getbreakfast("getbreakfast","1=1");
        call.enqueue(new Callback<breakresponce>() {
            ...
            public void onResponse(Call<breakresponce> call, Response<breakresponce> response) {
                if (response.body().getSuccess()==200) {
                    ...
                    breakfast=new breakfastadapter(showorderaddmin.this,bi);

                    recyclerView.setAdapter(breakfast);

                }
                else {
                    Toast.makeText(showorderaddmin.this, response.body().getMessage()+"", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<breakresponce> call, Throwable t) {
                Toast.makeText(showorderaddmin.this, t.getLocalizedMessage()+"", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void dinnerload(){
        ...
        Api api= ApiClient.getClient().create(Api.class);
        Call<dinnerresponce> call= api.getdinner("getbreakfast","1=1");
        call.enqueue(new Callback<dinnerresponce>() {
            ...
            public void onResponse(Call<dinnerresponce> call, Response<dinnerresponce> response) {
                if (response.body().getSuccess()==200) {
                    ...
                    dinnerad=new order_adapter(showorderaddmin.this,di);
    ...
    public void lunchload(){
        ...
        Api api= ApiClient.getClient().create(Api.class);
        Call<lunchresponce> call= api.getlunch("getbreakfast","1=1");
        call.enqueue(new Callback<lunchresponce>() {
            ...
            public void onResponse(Call<lunchresponce> call, Response<lunchresponce> response) {
                if (response.body().getSuccess()==200) {
                    ...
                    lunchad=new lunchadapter(showorderaddmin.this,li);
